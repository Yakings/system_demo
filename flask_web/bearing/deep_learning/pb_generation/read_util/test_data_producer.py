...
try:
    from models_mse_loss_explore.read_util import tensorflow_input
except:
...
path = '/home/sunyaqiang/Myfile/bearing/data_set/FEMTOBearingDataSet/Test_set/Test_set'

tf.app.flags.DEFINE_string('data_dir', path,
                           """Path to the CIFAR-10 data directory.""")
tf.app.flags.DEFINE_string('data_dir_test', '/home/store-1-img/sunyaqiang/foxcoon/test/',
                           """Path to the CIFAR-10 data directory.""")
