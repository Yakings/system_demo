...
try:
    from models.read_util import tensorflow_input
except:
...
path = '/home/sunyaqiang/Myfile/bearing/data_set/FEMTOBearingDataSet/Training_set/Learning_set'
path_test = '/home/sunyaqiang/Myfile/bearing/data_set/FEMTOBearingDataSet/Test_set/Test_set'
# path_test = path
...
IMAGE_SIZE = tensorflow_input.IMAGE_SIZE

NUM_CLASSES = tensorflow_input.NUM_CLASSES
...
def distorted_inputs(batch_size):
  ...
  # Image pocessing for training the network. Note the many random
  # distortions applied to the image.

  # Randomly crop a [height, width] section of the image.
  # distorted_image = tf.random_crop(reshaped_image, [height, width,1])

  #/home/sunyaqiang/MyFile/Chuangxin_Foxcoon/foxcoon_ngok/CTNModel.pb
  # res
  images.set_shape([batch_size, IMAGE_SIZE, 1])
...
def test_inputs(batch_size):
  ...
  if not FLAGS.data_dir:
    raise ValueError('Please supply a data_dir')
  data_dir = FLAGS.data_dir_test
  images, labels1 = tensorflow_input.test_inputs(data_dir=data_dir, batch_size=batch_size)
